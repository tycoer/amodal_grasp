...
data = dict(
    ...
    train=dict(
        ...
        ann_file=[data_root + 'camera/train.txt',
                  data_root + 'real/train.txt',
                  data_root + 'coco/annotations/instances_train2017_nocs.json'
                  ],
        img_prefix=[data_root + 'camera/train/',
                    data_root + 'real/real_train/',
                    data_root + 'coco/train2017/'
                    ],
        obj_model_dir=[data_root + 'obj_models/train/',
                       data_root + 'obj_models/real_train/',
                       None
                       ],
...
log_level = 'INFO'
work_dir = './work_dirs/nocs_r50_fpn_1x_stage2'
load_from = './work_dirs/nocs_r50_fpn_1x_stage1/latest.pth'
resume_from = None
workflow = [('train', 1)]
